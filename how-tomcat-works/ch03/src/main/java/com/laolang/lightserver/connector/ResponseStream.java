...
/**
 * Convenience implementation of <b>ServletOutputStream</b> that works with the standard
 * ResponseBase implementation of <b>Response</b>. If the content length has been set on
 * our associated Response, this implementation will enforce not writing more than that
 * many bytes on the underlying stream.
 *
...
public class ResponseStream extends ServletOutputStream {
    ...
    /**
     * Close this output stream, causing any buffered data to be flushed and any further
     * output data to throw an IOException.
     */
    ...
    /**
     * Flush any buffered data for this output stream, which also causes the response to
     * be committed.
     */
