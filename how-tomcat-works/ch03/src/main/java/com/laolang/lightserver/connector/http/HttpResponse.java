...
import com.laolang.lightserver.connector.ResponseStream;
import com.laolang.lightserver.connector.ResponseWriter;
...
import com.laolang.lightserver.util.CookieTools;
...
public class HttpResponse implements HttpServletResponse {
    ...
    /**
     * The HTTP headers explicitly added via addHeader(), but not including those to be
     * added with setContentLength(), setContentType(), and so on. This collection is
     * keyed by the header name, and the elements are ArrayLists containing the associated
    ...
    public void write(byte b[], int off, int len) throws IOException {
        if (!committed) { // 如果还没有提交（没发过 Header）
            sendHeaders(); // 在写入数据前强制发送 Header
        }
